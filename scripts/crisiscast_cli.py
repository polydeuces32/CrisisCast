...
class CrisisCastCLI:
 ...
 print(f"[ERROR] Data Check: Error - {e}")
 finally:
 db.close()
 ...
 print(f"[ERROR] Error: {forecast['error']}")
 return
 ...
 print(f"[ERROR] Error calculating volatility: {e}")
 ...
 print(f"[OK] Ingested data for symbols: {', '.join(symbols)}")
 else:
 await self.data_service.ingest_market_data(market)
 print(f"[OK] Ingested data for all {market} symbols")
 
 except Exception as e:
 print(f"[ERROR] Error ingesting data: {e}")
 ...
 print(f"[OK] Models trained for {market}")
 else:
 await self.ml_service.train_all_models()
 print("[OK] Models trained for all markets")
 ...
 print(f"[ERROR] Error listing alerts: {e}")
 finally:
 db.close()
 ...
 print(f"[OK] Alert created with ID: {alert.id}")
 ...
 print(f"[ERROR] Test notification failed: {result['message']}")
 
 except Exception as e:
 print(f"[ERROR] Error testing alert: {e}")
 finally:
 db.close()
 ...
 print(f"[ERROR] Error showing data stats: {e}")
 finally:
 db.close()
 
 async def show_config(self):
 """Show current configuration"""
 print(" CrisisCast Configuration")
 print("=" * 50)
 ...
 # Check API keys
 print(f"\nAPI Keys:")
 print(f" OpenAI: {'[OK] Set' if settings.openai_api_key else '[ERROR] Not set'}")
 print(f" Alpha Vantage: {'[OK] Set' if settings.alpha_vantage_api_key else '[ERROR] Not set'}")
 print(f" CoinMarketCap: {'[OK] Set' if settings.coinmarketcap_api_key else '[ERROR] Not set'}")
